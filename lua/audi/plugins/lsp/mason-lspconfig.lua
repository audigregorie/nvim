-- LSP support handling server registration and configuration
-- return {
...
--     -- Create a reusable on_attach function
--     local on_attach = function(client, bufnr)
--       -- Your existing on_attach logic here (keymaps, etc.)

--       -- Attach navic if the client supports documentSymbolProvider
...
--                 invalidApply = "error",  -- Error for invalid @apply usage
--                 invalidScreen = "error",
...
return {
	...
	config = function()
		...
		mason_lspconfig.setup({
			ensure_installed = {
				"ts_ls", -- Fixed name from "ts_ls" to standard Mason name
				"html",
				"cssls",
				"lua_ls",
				"angularls",
		...
		mason_lspconfig.setup_handlers({
			...
			-- Custom handler for ts_ls (previously "ts_ls")
			["ts_ls"] = function()
				lspconfig.ts_ls.setup({
					capabilities = capabilities,
					on_attach = vim.g.common_on_attach,
