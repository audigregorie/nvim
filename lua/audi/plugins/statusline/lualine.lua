...
return {
  ...
  config = function()
    ...
    if not conditions_ok then
      ...
      conditions = {
        buffer_not_empty = function() return true end,
        hide_in_width = function() return true end,
        check_git_workspace = function() return true end,
      }
    end
    ...
    if not getShitDone_ok then
      ...
      getShitDone = function() return "Focus" end
    end
