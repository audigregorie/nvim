-- LSP support handling keybindings and diagnostics
-- return {
...
return {
	...
	config = function()
		...
		-- Define common on_attach function that will be used by mason-lspconfig
		vim.g.common_on_attach = function(client, bufnr)
			-- Set up buffer-local keymaps
			...
			-- Check for navic support and attach if available
