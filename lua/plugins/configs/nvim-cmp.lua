return {
	...
	config = function()
		...
		-- Check if cmp is available - critical
		...
		-- Check if luasnip is available - critical
		...
		-- Load friendly-snippets - non-critical, can be simplified
		pcall(function()
		...
		-- Setup for / search completion - non-critical
		pcall(function()
			cmp.setup.cmdline("/", {
		...
		-- Setup for : command completion - non-critical
		pcall(function()
			cmp.setup.cmdline(":", {
				mapping = cmp.mapping.preset.cmdline(),
				sources = cmp.config.sources({
		...
		-- Setup highlight groups - non-critical
		pcall(function()
