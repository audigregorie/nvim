	...
	config = function()
		...
		local custom_lualine_theme = {
			normal = {
				...
				c = { fg = "#dddddd", bg = "#0F0F0F", gui = "bold" }, -- Example: section 'a' foreground black, background orange
			},
			inactive = {},
			-- Add other modes like 'insert', 'visual', 'replace', etc., if you want different colors for them
			insert = {
				a = { fg = "#dddddd", bg = "#588157", gui = "bold" }, -- Example: section 'a' foreground black, background orange
			},
		}
