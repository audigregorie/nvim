...
return require("lazy").setup({
	...
	{ import = "plugins.configs.core.conform" }, -- Handles formatting and diagnostics for LSP
	{ import = "plugins.configs.core.mason" }, -- Package manager for LSP, DAP, linters, formatters
	{ import = "plugins.configs.core.mason-lspconfig" }, -- Bridges Mason with lspconfig for easier setup
	{ import = "plugins.configs.core.nvim-cmp" }, -- Autocompletion framework
	{ import = "plugins.configs.core.nvim-lint" }, -- Hangles linting for LSP
	{ import = "plugins.configs.core.nvim-lspconfig" }, -- Easy configuration for built-in LSP support
	{ import = "plugins.configs.core.treesitter" }, -- Treesitter for better syntax highlighting and parsing

	{ import = "plugins.configs.colorscheme" }, -- Color scheme management
	{ import = "plugins.configs.core.oil" }, -- A file explorer alternative with a minimal UI
